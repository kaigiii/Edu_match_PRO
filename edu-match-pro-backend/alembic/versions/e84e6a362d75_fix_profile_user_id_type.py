...
down_revision: Union[str, None] = 'd0b5c13235bd'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_wide_edu_B_1_4_county', table_name='wide_edu_B_1_4')
    op.drop_index('ix_wide_edu_B_1_4_year', table_name='wide_edu_B_1_4')
    op.drop_table('wide_edu_B_1_4')
    op.drop_index('ix_wide_faraway3_code', table_name='wide_faraway3')
    op.drop_index('ix_wide_faraway3_county', table_name='wide_faraway3')
    op.drop_index('ix_wide_faraway3_year', table_name='wide_faraway3')
