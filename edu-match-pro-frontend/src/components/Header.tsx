      ...
      <div className="w-full max-w-7xl mx-auto flex justify-between items-center px-4 h-20 transition-all duration-300 relative">
        ...
        <div className="flex items-center space-x-4 md:space-x-8">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <motion.div whileHover={{ y: -2, color: '#3b82f6' }} whileTap={{ scale: 0.95 }}>
              <Link to="/smart-exploration" className="text-neutral-500 hover:text-brand-blue transition-colors flex items-center space-x-1">
                <span>智慧探索</span>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-3 space-y-2">
            ...
            <Link to="/smart-exploration" className="block text-neutral-600 hover:text-brand-blue" onClick={() => setMobileOpen(false)}>智慧探索 ✨</Link>
