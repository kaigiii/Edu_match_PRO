...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* 備用背景 - 當影片載入失敗或未載入時顯示 */}
      <div
        className={`absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-gray-100 z-0 transition-opacity duration-1000 ${videoLoaded && !videoError ? 'opacity-0' : 'opacity-100'
          }`}
      />
