  ...
  const values = [
    {
      ...
      color: "blue",
      image: `/images/impact-stories/background-wall/01.jpg`,
      stats: "95% 準確率",
    ...
    },
    {
      ...
      color: "amber",
      image: `/images/impact-stories/background-wall/05.jpg`,
      stats: "300+ 成功案例",
    ...
    },
    {
      ...
      color: "emerald",
      image: `/images/impact-stories/background-wall/09.jpg`,
      stats: "80% 效率提升",
            ...
            >
              ...
              <div className="relative h-40 sm:h-48 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center backdrop-blur-sm ${value.color === 'blue' ? 'bg-blue-500/20' :
                      value.color === 'amber' ? 'bg-amber-500/20' :
                        'bg-emerald-500/20'
                    }`}>
                    <value.icon className={`w-6 h-6 ${value.color === 'blue' ? 'text-blue-600' :
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-1 sm:space-y-2">
                  {value.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center text-xs sm:text-sm text-gray-600">
                      <div className={`w-2 h-2 rounded-full mr-3 ${value.color === 'blue' ? 'bg-blue-500' :
                ...
                {/* 懸停時顯示的按鈕 */}
                <div className={`mt-4 sm:mt-6 transition-all duration-300 ${hoveredCard === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                  }`}>
                  <button
                    onClick={() => handleLearnMore(index)}
                    className={`w-full py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 ${value.color === 'blue' ? 'bg-blue-600 hover:bg-blue-700 text-white' :
              ...
              {/* 卡片邊框光效 */}
              <div className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${value.color === 'blue' ? 'bg-gradient-to-r from-blue-400/20 to-blue-600/20' :
